...
class AccessControlApi(object):
    ...
    def invitation_redeem(self, invitation_id, user_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.invitation_redeem(invitation_id, user_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.invitation_redeem_with_http_info(invitation_id, user_id, **kwargs)
        else:
            (data) = self.invitation_redeem_with_http_info(invitation_id, user_id, **kwargs)
            return data

    def invitation_redeem_with_http_info(self, invitation_id, user_id, **kwargs):
        """
        Assign all roles assigned to the invitation to the specified user, removing the invitation and related configuration when done. Note: We may have to change the role assignment to an asynchronous task depending on the complexity of the implementation.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.invitation_redeem_with_http_info(invitation_id, user_id, callback=callback_function)
        ...
        all_params = ['invitation_id', 'user_id']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'invitation_id' is set
        if ('invitation_id' not in params) or (params['invitation_id'] is None):
            raise ValueError("Missing the required parameter `invitation_id` when calling `invitation_redeem`")
        # verify the required parameter 'user_id' is set
        if ('user_id' not in params) or (params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `invitation_redeem`")
        ...
        return self.api_client.call_api('/invitations/{invitation_id}/redeem/{user_id}/', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
