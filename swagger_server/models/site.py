...
class Site(Model):
    ...
    """
    def __init__(self, id: int=None, name: str=None, client_id: str=None, domain_id: int=None, description: str=None, created_at: datetime=None, updated_at: datetime=None):
        """
